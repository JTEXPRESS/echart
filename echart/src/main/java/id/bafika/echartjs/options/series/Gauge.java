...
import id.bafika.echartjs.options.Title;
import id.bafika.echartjs.options.axis.AxisLine;
import id.bafika.echartjs.options.axis.AxisTick;
import id.bafika.echartjs.options.axis.SplitLine;
import id.bafika.echartjs.options.code.SeriesType;
import id.bafika.echartjs.options.series.gauge.Detail;
import id.bafika.echartjs.options.series.gauge.Pointer;

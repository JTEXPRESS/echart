...
import id.bafika.echartjs.options.code.EffectType;
import id.bafika.echartjs.options.code.SeriesType;
import id.bafika.echartjs.options.code.ShowEffectOn;
import id.bafika.echartjs.options.series.other.RippleEffect;

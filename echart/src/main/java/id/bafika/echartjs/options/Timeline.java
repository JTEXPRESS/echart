...
import id.bafika.echartjs.options.code.ControlPosition;
import id.bafika.echartjs.options.code.TimeLineType;
import id.bafika.echartjs.options.style.CheckpointStyle;
import id.bafika.echartjs.options.style.ControlStyle;
